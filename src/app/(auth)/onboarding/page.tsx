  ...
  return (
    <Card className="w-full max-w-sm border-zinc-800 bg-zinc-950 text-white shadow-xl">
      <CardHeader className="space-y-1 pb-4">
        ...
        <CardTitle className="text-center text-xl font-semibold">Your company</CardTitle>
        <CardDescription className="text-center text-zinc-400">
          Step 2 of 2 — Create your organization
        </CardDescription>
      </CardHeader>
      ...
      <CardContent className="pb-6">
        <form action={action} className="flex flex-col gap-4">
          ...
          >
            {pending ? "Creating..." : "Create company and continue"}
          </button>
        </form>
      </CardContent>
    </Card>
